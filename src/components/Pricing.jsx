  ...
  const plans = [
    {
      ...
      features: [
        ...
        'Concept & theme suggestion',
        'Basic event flow creation',
        'Designing promotional posters & creatives',
        'Registration link & page setup',
        'On day support and coordination',
    ...
    },
    {
      ...
      features: [
        ...
        'Full event flow desgin',
        'PrintLab 25% discount',
        'Marketing strategy',
        'Vendor coordination',
        'Post-event reporting',
        'On day event handling',
      ],
    ...
    },
    {
      ...
      features: [
        ...
        'Dedicated event head & professional manpower',
        'Creative concept+theme+stage flow design',
        'PrintLab 35% discount',
        'High impact marketing campaign',
        'Vendor and logistic management',
        'Custom integrations',
        'Official landing page & ticketing support',
